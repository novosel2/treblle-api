...
public interface ILogsRepository
{
    ...
    Task<(List<Log>, int Total)> GetLogsAsync(int page, int limit, SortByEnum sortBy, SortDirEnum sortDir,
    ...
    Task<(List<Problem>, int Total)> GetProblemsAsync(int page, int limit, SortByEnum sortBy, SortDirEnum sortDir,
            MethodsEnum[]? methods, int[]? statusCodes, double? responseLte, double? responseGte,
